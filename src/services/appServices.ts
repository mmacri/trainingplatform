...
import { getCourseCompletionState, type CourseCompletionState } from "./courseCompletionService";
import type {
  AccessRequest,
  AppData,
  Assessment,
...
export { getCourseCompletionState, type CourseCompletionState };
...
export class AuthService {
  static async boot() {
    ...
    const fresh = createCurrentSeedData();
